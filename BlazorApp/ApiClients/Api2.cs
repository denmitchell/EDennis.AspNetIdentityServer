...
namespace BlazorApp {
    public class Api2 {
        ...
        public Api2(IHttpClientFactory httpClientFactory) {
            _client = httpClientFactory.CreateClient("Api2");
        }

        public async Task<IEnumerable<ClaimViewModel>> GetClaimsFromApi2() {
